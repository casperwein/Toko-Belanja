...
const { findIdCategory, checkProductBeforeDelete } = require("../helpers/findById")
const router = express.Router();

router.use(authentication, adminAuthorization);
router.post("/", categoriesController.postCategories);
router.get("/", categoriesController.getAll);
router.patch("/:categoryId", findIdCategory, categoriesController.updateCategories)
router.delete("/:categoryId", findIdCategory, checkProductBeforeDelete, categoriesController.deleteCategories)
