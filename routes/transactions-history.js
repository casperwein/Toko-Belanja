...
router.get("/user", authentication, customerAuthorization, transaction.getAllByUser)
router.get("/admin", authentication, adminAuthorization, transaction.getAllByAdmin)
router.get("/:transactionId", authentication, adminAuthorization, transaction.getTransactionById)
